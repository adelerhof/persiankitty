...
function build_image {
  ...
  docker build . --file Dockerfile --tag ghcr.io/adelerhof/piepkip:${TAG}
  docker build . --file Dockerfile --tag ghcr.io/adelerhof/piepkip:latest
  # docker build . --file Dockerfile --tag harbor.adelerhof.eu/piepkip/piepkip:${TAG}
  # docker build . --file Dockerfile --tag harbor.adelerhof.eu/piepkip/piepkip:latest
...
function push_image {
  ...
  docker push ghcr.io/adelerhof/piepkip:${TAG}
  docker push ghcr.io/adelerhof/piepkip:latest
...
function cleanup {
  ...
  docker rmi -f ghcr.io/adelerhof/piepkip:${TAG}
  docker rmi -f ghcr.io/adelerhof/piepkip:latest
